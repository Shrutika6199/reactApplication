...
<div>
    ...
    <h1>{user.login}</h1>  
    <a href={user.html_url} target='_blank' rel="noreferrer">Profile Link</a>  
    </div>  
)  
}
...
return(
<>
<h1>{guserDetails.id},{guserDetails.login}</h1>
<img src={guserDetails.avatar_url} alt="not found" width="100px" height="200px"/>
</>
)
}
